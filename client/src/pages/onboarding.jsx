...
export default function OnBoarding() {
  ...
  return (
    <div className="bg-panel-header-backgroun h-screen w-screen flex flex-col items-center justify-center">
      <div className="flex items-center justify-center gap-2 mb-25">
        <Image
          ...
          width={300}
        />
        <span className="text-7xl">Msg You</span>
      </div>
      <div className="mt-20">
      ...
      <div className="flex gap-6 mt-6 ">
        <div className="flex flex-col items-center justify-between mt-5 gap-6">
          ...
          <div className="flex items-center justify-center">
            <button
              className="bg-search-input-container-background p-5 rounded-lg border-black border"
              onClick={onBoardUser}
            >
              Create Profile
            </button>
